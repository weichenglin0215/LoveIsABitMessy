...
def build_page():
    ...
    try:
        template = env.get_template('daily_page_template.html')
    except Exception as e:
        print(f"載入 daily_page_template.html 失敗: {e}")
        return
...
"""
    ...
    for page in ['lpas.html', 'admin.html', 'daily_run.html', 'characters_editor.html', 'novel_generator.html']:
