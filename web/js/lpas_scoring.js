...
function calculateScores(answers) {
    ...
    const radarData = {
        labels: ["主動/被動", "外放/內收", "乾脆/留戀", "快速/緩慢"],
        datasets: []
    };

    const periodNames = { 1: "曖昧期", 2: "熱戀期", 3: "失戀期" };
    const periodColors = {
        1: "rgba(156, 111, 214, 0.3)",
        2: "rgba(111, 214, 156, 0.3)",
        3: "rgba(214, 111, 138, 0.3)"
    };
    const periodBorder = {
        1: "hsla(266, 56%, 64%, 1.00)",
        2: "hsla(146, 56%, 64%, 1.00)",
        3: "hsla(344, 56%, 64%, 1.00)"
    };
