...
let state = {
    ...
    storyPremise: "分成起承轉合四章，故事背景在大學圖書館，兩人都是大學生。\n\n"
        + "起：描述女主角與心儀對象在圖書館《因一本書而相遇的情境》。\n\n"
        + "承：因參加活動編在同組有了更多互動機會，也因此《產生令兩人感到尷尬的小誤會》。\n\n"
        + "轉：巧妙化解了兩人誤會之後，卻總是在要《更進一步發展親密關係》的時候發生一些狀況而中斷，讓兩人都很苦惱。\n\n"
        + "合：當兩人總算是成為男女朋友，最後才發現這一切都是女主在《回憶與已過世的男主交往過程》。\n\n"
        + "目前現實中為女主角在整理男主的遺物時，所發現的日記，記錄了兩人《從相識到相戀的過程》。", // 故事粗綱
