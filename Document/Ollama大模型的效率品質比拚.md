# 結論寫在前面
## 角色編輯器 文字創造角色、人像圖片提示詞
- 4090 24GB，`qwen3.6:27b` 17GB 或 `gemma4:31b` 19GB，上下文至少 `32768`(依文章長度)，否則會亂碼或輸出不全。
- 文章有暴力色情，`VladimirGav/gemma4-26b-16GB-VRAM-Uncensored:latest`，13 GB
- 4060 盡量不用

## LoveLine 聊天
- 4090 24GB或 4060 16GB，`huihui_ai/gemma-4-abliterated:e4b`，9.6 GB 或 `sorc/qwen3.5-instruct-uncensored:9b` 9.5GB，上下文 `8192` 或 `16384` 
