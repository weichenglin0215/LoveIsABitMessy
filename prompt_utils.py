...
【寫作技巧】
1. 參考並分析「故事粗綱」的故事背景、角色設定、角色動機、目標、行為、情緒描述與關鍵的物品與時間點，解析出本章的核心重點，並銜接上下章的劇情。
2. 章描述的重點在於根據上述分析來轉換成每一位角色的實際行動與關鍵對話，並善於安排其他角色的戲份，創造出多角關係，讓故事更精彩。
3. 要以角色個性與創意優先，讓角色個性與創意來推動故事架構與推進劇情發展。
4. 劇情要出乎意料但又在情理之中，符合長篇小說的起承轉合。
5. 每一章都要有關鍵的轉折劇情，且具有張力與懸念，勾引讀者繼續閱讀的慾望。
6. 在「故事粗綱」之中有提到包含「(請構思)」的句子，請特別為此句內容以條列 1. 2. 3. ...方式，發想多個能夠強力推動劇情或合理化劇情的內容。
